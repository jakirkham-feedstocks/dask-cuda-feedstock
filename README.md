...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dask-cuda-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12463&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dask-cuda-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dask-cuda` can be installed with:

```
conda install dask-cuda
```

It is possible to list all of the versions of `dask-cuda` available on your platform with:
